...
//  //change attributes - SLIDE 10 (example 2)
//  let img = document.querySelector('img');
//  img.src = 'img/husky.jpg';

// //change style - SLIDE 11 (example 3)
// theH1.classList.add('text-success');
// img.classList.add('anim')

// //create an element -- SLIDE 12 (example 4)
...
// //USE Function to add item(s) - SLIDE 13 (example 5)
...
// // USE Function to add n number by iterating - SLIDE 13 (example 5 continued)
...
// // Add Event Listener - SLIDE 15 (example 6)
...
// let isPuppy = true;     //global variable
